...
# source.include_patterns = data/img/*,data/logo/*,backend/*,frontend/*
...
requirements = android, asynckivy, beautifulsoup4, certifi, dill, expiringdict, icalendar, jnius, kivy, kivymd, matplotlib, networkx, plyer, pyjnius, python3, requests
